...
>
  ...
  {/* LEFT – users */}
  <aside className={` border-0 sm:border-r ${users.length === 0 ? 'flex flex-col justify-between':''} border-[#343434] pr-4`}>
    <div>
        <h1 className="text-white text-xl sm:text-2xl font-medium mb-2">Current Agents</h1>
    <p className="text-white/70 text-xs mt-2 mb-4">
      Click on the current agents to edit them
    </p>
    </div>
    {users.length === 0 ? 
 ...
 <form className="flex flex-col pl-0 sm:pl-6 gap-6 w-full sm:max-w-2xl">
  ...
  <div className="mb-2">
    ...
    <div>
    <h1 className="text-2xl font-medium text-white">Edit Agent</h1>
    ...
    >
    <div className="">
        <h1 className="text-xl sm:text-2xl font-medium text-white">Edit / Add  / Delete Agents</h1>
