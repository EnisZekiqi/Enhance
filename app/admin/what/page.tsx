...
const [imagePreview, setImagePreview] = useState<string | null>(null)
   ...
   const clickEdit = (what: What) => {
  setShowEdit(what.id);
 setFormData({
    title_en: what.title.en,
    title_fr: what.title.fr,
    description_en: what.description.en,
    description_fr: what.description.fr,
  });

  setImageFile(null);
  setImagePreview(
    what.image ? `http://localhost:3010${what.image}` : null
  );
};
